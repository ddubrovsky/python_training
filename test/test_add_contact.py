...
def test_add_contact(app):
    ...
    contact = Contact(fname="Arnold", lname="Schwarzenegger", nick="Arni", title="Actor and governor",
                      ...
                      work="01234567", email="arni@hollywood.com", email2="arni2@hollywood.com", email3="arni3@hollywood.com",
                      bday="30", bmonth="July", byear="1947", address2="mansion near LA", phone2="5558882221",
                      notes="bla-bla-bla")
